              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('uploads/products/'.$shops->image)}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{asset('uploads/products/'.$shops->image)}}" data-bs-toggle="tooltip"
                  ...
                  @foreach (explode(',', $shops->images) as $gimg )
                  <div class="swiper-slide product-single__image-item">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumbnail')}}/{{$shops->image}}" width="104" height="104" alt="" /></div>
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            <span class="current-price">
              @if ($shops->sale_price)
                <s>${{$shops->regular_price}}</s> ${{$shops->sale_price}}
              @else
                  ${{$shops->regular_price}}
              @endif
            </span>
          ...
          <div class="product-single__short-desc">
            <p>{{$shops->short_description}}</p>
          </div>
          @if (Cart::instance('cart')->content()->where('id',$shops->id)->count()>0)
          ...
          <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="price" value="{{$shops->sale_price == "" ? $shops->regular_price : $shops->sale_price }}">
          ...
          <div class="product-single__addtolinks">
            @if (Cart::instance('wishlist')->content()->contains('id', $shops->id))
            <form action="{{ route('wishlist.item.remove', ['rowId' =>Cart::instance('wishlist')->content()->where('id',$shops->id)->first()->rowId]) }}" method="POST" style="display: inline;">
              @csrf
              @method('DELETE')
              <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist " style="color: orange;" onclick="this.closest('form').submit();">
            ...
            @else
                  <form name="addtowishlist-form" method="post" action="{{ route('wishlist.add') }}">
                      ...
                      <input type="hidden" name="name" value="{{ $shops->name }}">
                      <input type="hidden" name="price" value="{{ $shops->sale_price == '' ? $shops->regular_price : $shops->sale_price }}">
                      <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="this.closest('form').submit();">
                          <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <use href="#icon_heart" />
                          </svg>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="{{route('shops.details',['product_slug'=>$shop->slug])}}">
                    <img loading="lazy" src="{{asset('uploads/products/'. $shop->image)}}" width="330" height="400"
                  ...
                  @if (Cart::instance('cart')->content()->where('id', $shop->id)->isNotEmpty())
                      <a href="{{route('cart.index')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn btn-warning mb-5">Go to Cart</a>
                  @else
                      <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                          @csrf
                          ...
                          <input type="hidden" name="price" value="{{$shop->sale_price == "" ? $shop->regular_price : $shop->sale_price }}">
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title"><a href="details.html">{{$shop->name}}</a></h6>
