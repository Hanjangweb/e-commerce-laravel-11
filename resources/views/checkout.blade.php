              ...
              <div class="col-md-12">
                <div class="my-account_address-list">
                  <div class="my-account_address-list-item">
                    <div class="my-account_address-item-details">
                      <p>{{$address->name}}</p>
                      <p>{{$address->address}}</p>
          ...
          <div class="checkout__totals-wrapper">
            <div class="sticky-content">
              <div class="checkout__totals">
                ...
                <table class="cart-totals">
                  <tbody>
                      ...
                      <tr>
                          <th>VAT</th>
                          <td class="text-right">{{ Session::get('discounts')['tax'] ?? '0.00' }}</td>
                      </tr>
                      <tr>
                          <th>Total</th>
                          <td class="text-right">{{ Session::get('discounts')['total'] ?? Cart::instance('cart')->total() }}</td>
                      </tr>
                  </tbody>
                </table>
                @else
              ...
              <div class="checkout__payment-methods">
                ...
                <div class="form-check">
                  <input class="form-check-input form-check-input_fill" type="radio" name="mode"
                    id="checkout_payment_method_4" value="cod">
