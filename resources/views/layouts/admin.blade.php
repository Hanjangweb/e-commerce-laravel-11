...
<head>
    ...
    <link rel="stylesheet" type="{{asset('text/css" href="css/sweetalert.min.css')}}">
    <link rel="stylesheet" type="{{asset('text/css" href="css/custom.css')}}">
    @stack('style')
</head>
<body class="body">
    <div id="wrapper">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('home.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header-1" alt="" src="{{asset('images/logo/favicon.png')}}"
                                data-light="{{asset('images/logo/favicon.png')}}" data-dark={{asset('images/logo\favicon.png')}}">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{asset('images/logo/favicon.png')}}"
                                        data-light="{{asset('images/logo/favicon.png')}}" data-dark="{{asset('images/logo/favicon.png')}}"
                                        data-width="154px" data-height="52px" data-retina="{{asset('images/logo/favicon.png')}}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    ...
                                                    <span class="text-tiny">{{ Auth::user()->role_name }}</span>
                                                </span>
                                            </span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
